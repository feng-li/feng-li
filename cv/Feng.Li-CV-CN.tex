...
\begin{tabular}{lp{9cm}ccl}
  ...
  \midrule
gratis      & Efficient algorithms for generating time series with diverse and controllable characteristics. {\color{blue}(Selected in R Task View for Time Series)}. & R        & All         & CRAN, GitHub \\
...
dng         & Distribution and Gradients for Skewed Distributions  {\color{blue}(Selected in R Task View for Probability Distributions)}                                                                 & R        & All         & CRAN, GitHub \\
...
\begin{center}
  \resizebox{\textwidth}{!}{
    \begin{tabular}{llll}
      ...
      \midrule
      \textbf{AI驱动的预测}                     & 本科、硕士、博士 & 北京大学光华管理学院           & 2025 --          \\
