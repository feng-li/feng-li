...
\section{期刊任职}
\begin{itemize}
\item 国际期刊 \href{https://www.sciencedirect.com/journal/international-journal-of-forecasting}{International Journal of Forecasting} (JCR Q1, IF 7. 5) 副主编 （2025+）

\item 国际期刊 \href{https://www.sciencedirect.com/journal/journal-of-multivariate-analysis}{Journal of Multivariate Analysis} (JCR Q1) 副主编 (2026 +)
\end{itemize}
...
\item 指导超过50名本科生和研究生（包括MBA和EMBA学生）毕业论文。学生或进入顶尖高校攻读博士学位，或在联合国等国际组织、字节跳动和腾讯等领先科技公司、主要金融机构和研究组织任职。
\item 任北京大学——香港大学 EMBA 项目学术导师。
\item 任2026年光华——大众汽车集团整合实践项目指导教师。
\item 他还指导过联合国大数据黑客松（2022--2023）等具有国际影响力的竞赛。
...
\item   担任统计学、计算机与人工智能、管理学等领域60余种国际期刊的匿名评审，过去五年撰写160多个高质量匿名论文评审意见。期刊评审记录详见 \url{https://orcid.org/0000-0002-4248-9778}。以下列出部分常审稿期刊。
