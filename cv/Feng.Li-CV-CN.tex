...
\usepackage{enumitem}
\setlist[enumerate,itemize]{leftmargin=\parindent}% Indented paragraphs within lists

%% BibLaTeX
\usepackage[backend=biber, style=authoryear, sorting=ydnt, %bibstyle=numeric, %dashed=none,
...
\fancypagestyle{plain}{%
  ...
  \fancyfoot[LO,RE]{\vspace{0.5cm}\tiny\emph{修改日期： \today \\最新个人简历请访问}  \url{https://feng.li/}}
  \fancyfoot[C]{}
